...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name container-registry-k8s-auth-controller-builder
	$(CONTAINER_TOOL) buildx use container-registry-k8s-auth-controller-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm container-registry-k8s-auth-controller-builder
	rm Dockerfile.cross
